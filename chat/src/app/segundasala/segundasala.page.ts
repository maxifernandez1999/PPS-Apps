...
@Component({
  selector: 'app-segundasala',
  templateUrl: './segundasala.page.html',
  styleUrls: ['./segundasala.page.scss'],
})
export class SegundasalaPage implements OnInit {
  ...
  constructor(router:Router, private servicioFirestore:MensajesfirestoreService,private servicioRealTime:MensajesrealtimeService) {
    this.servicioRealTime.dbPath = "/mensajesSegundaSala";
