...
@Component({
  selector: 'app-perfil-cosas-feas',
  templateUrl: './perfil-cosas-feas.page.html',
  styleUrls: ['./perfil-cosas-feas.page.scss'],
})
export class PerfilCosasFeasPage implements OnInit {
